<template>
  <div class="mod-sys__menu">
    ...
    <el-table v-loading="state.dataListLoading" :data="state.dataList" show-overflow-tooltip row-key="id" border style="width: 100%">
      <el-table-column prop="menuName" label="名称" header-align="center" min-width="100"></el-table-column>
...
<!--      </el-table-column>-->
      ...
      <el-table-column prop="path" label="路由" header-align="center" align="center" width="150"></el-table-column>
      <el-table-column prop="permission" label="授权标识" header-align="center" align="center" width="200"></el-table-column>
      <el-table-column label="操作" fixed="right" header-align="center" align="center" width="170">
        <template v-slot="scope">
          <el-button v-if="state.hasPermission('sys:menu:save') && scope.row.type === 0" type="primary" link @click="addHandle(scope.row)">新增</el-button>
