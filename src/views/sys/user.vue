<template>
  <div class="mod-sys__user">
    <el-form :inline="true" :model="state.dataForm" @keyup.enter="state.getDataList()">
      <el-form-item>
        <el-input v-model="state.dataForm.userNo" placeholder="用户名" clearable></el-input>
      </el-form-item>
<!--      <el-form-item>-->
<!--        <chimera-select v-model="state.dataForm.gender" dict-type="gender" placeholder="性别"></chimera-select>-->
<!--      </el-form-item>-->
      <el-form-item>
        <chimera-dept-tree v-model="state.dataForm.deptId" placeholder="选择部门" :query="true"></chimera-dept-tree>
      </el-form-item>
      <el-form-item>
...
<!--      </el-form-item>-->
    ...
    <el-table v-loading="state.dataListLoading" :data="state.dataList" border @selection-change="state.dataListSelectionChangeHandle" @sort-change="state.dataListSortChangeHandle" style="width: 100%">
      ...
      <el-table-column prop="userNo" label="用户名" sortable="custom" header-align="center" align="center"></el-table-column>
