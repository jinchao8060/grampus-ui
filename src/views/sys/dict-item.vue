...
import AddOrUpdate from "./dict-item-add-or-update.vue";
...
const view = reactive({
  getDataListURL: "/system/dict/item/page",
  getDataListIsPage: true,
  deleteURL: "/system/dict/item",
  deleteIsBatch: true,
  dataForm: {
    dictId: props.dictId,
    dictLabel: null,
...
const addOrUpdateHandle = (id?: number) => {
  addOrUpdateRef.value.dataForm.dictId = props.dictId;
