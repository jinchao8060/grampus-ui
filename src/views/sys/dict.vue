<template>
  <div class="mod-sys__dict">
    ...
    <!-- 字典类型数据 -->
    <el-drawer v-if="dictDataVisible" v-model="dictDataVisible" :title="state.focusDictTypeTitle" :size="800" :close-on-press-escape="false" class="rr-drawer"> <DictTypeList :dictId="state.focusDictId"></DictTypeList></el-drawer>
  </div>
</template>
...
const view = reactive({
  getDataListURL: "/system/dict/page",
  getDataListIsPage: true,
  deleteURL: "/system/dict",
  deleteIsBatch: true,
  dataForm: {
    id: "0",
    dictName: "",
