<template>
  <div class="ca-login">
    <div class="ca-login-wrap">
      <div class="ca-login-middle">
        <div class="ca-login-middle-main">
          <h4 class="ca-login-middle-main-title">登录</h4>
          <el-form ref="formRef" label-width="80px" :status-icon="true" :model="login" :rules="rules" @keyup.enter="onLogin">
            <el-form-item label-width="0" prop="username">
              <el-input v-model="login.userNo" placeholder="用户名" prefix-icon="user" autocomplete="off"></el-input>
            </el-form-item>
...
<!--              <el-space class="ca-login-middle-main-code">-->
...
<!--            </el-form-item>-->
            <el-form-item label-width="0">
              <el-button type="primary" size="small" :disabled="state.loading" @click="onLogin" class="ca-login-middle-main-btn"> 登录 </el-button>
            </el-form-item>
          </el-form>
        </div>
      </div>
    ...
    <div class="login-footer">
      <p><a href="https://www.baidu.com/" target="_blank">Chimera</a>{{ state.year }} © oceancloud.com</p>
    </div>
  </div>
</template>
...
const login = reactive({ userNo: "", password: "", captcha: "", uuid: "" });
...
const rules = ref({
  userNo: [{ required: true, message: "必填项不能为空", trigger: "blur" }],
